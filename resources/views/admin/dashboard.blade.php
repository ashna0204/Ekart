              ...
              <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="assets{{('adminlte/dist/assets/img/user1-128x128.jpg')}}"
                        alt="User Avatar"
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="assets{{('adminlte/dist/assets/img/user8-128x128.jpg')}}"
                        alt="User Avatar"
                        class="img-size-50 rounded-circle me-3"
                      />
                    </div>
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="assets{{('adminlte/dist/assets/img/user3-128x128.jpg')}}"
                        alt="User Avatar"
                        class="img-size-50 rounded-circle me-3"
                      />
                    </div>
            ...
            <li class="nav-item dropdown user-menu">
              ...
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  <img
                    src="assets{{('adminlte/dist/assets/img/user2-160x160.jpg')}}"
                    ...
                    <table class="table table-striped align-middle">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <img
                              src="{{asset('adminlte/dist/assets/default-150x150.png')}}"
                              alt="Product 1"
